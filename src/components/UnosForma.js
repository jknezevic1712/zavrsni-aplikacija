         ...
         && zanr !== ""){
            setKnjige([
                ...
                {key: Math.round(Math.random() * 1000), naziv: naziv, autor: autor, godinaIzdanja: godinaIzdanja,
                    izdavac: izdavac, zanr: zanr, dostupna: 1, posudio: posudio}
            ]);
