        ...
        <div className={style.body}>
            <div className={style.modal}>
                ...
                <div className={style.listaPodaci}>
                    <p>
                        Student treće godine "Primjena informacijske tehnologije u poslovanju" (<a href="https://www.foi.unizg.hr/hr/studiji/pitup" target="_blank" rel="noreferrer">PITUP</a>) na fakultetu "Fakultet Organizacije i Informatike" (<a href="https://www.foi.unizg.hr/" target="_blank" rel="noreferrer">FOI</a>) u Varaždinu. Aplikacija je namijenjena završnom radu "Usporedba platformi za razvoj aplikacija u oblacima".
                    </p>
                    <h3>Osobni podaci:</h3>
                    <ul>
